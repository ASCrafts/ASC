export type ProgramSlug = "workshops" | "foundation-program" | "professional-program" | "mastery-program";
  ...
  cybersecurity: {
    ...
    programs: {
      "workshops": {
        ...
        duration: "Monthly",
        overview:
          "Stay informed about the latest cybersecurity trends, threats, and defensive practices through our free monthly workshops. These sessions are designed for students, professionals, business owners, and technology enthusiasts who want to strengthen their cybersecurity awareness.",
        outcomes: [
      ...
      "foundation-program": {
        ...
        duration: "15 Days",
        overview:
          "The Foundation Program provides a structured introduction to cybersecurity concepts, networking fundamentals, operating systems, and security principles. It is designed to build a strong base for individuals starting their cybersecurity journey.",
        outcomes: [
      ...
      "professional-program": {
        ...
        duration: "30 Days",
        overview:
          "A practical and career-focused program designed to help learners develop hands-on cybersecurity skills used by security analysts, SOC teams, and ethical hackers.",
        outcomes: [
      ...
      "mastery-program": {
        name: "Cybersecurity Mastery Program",
        level: "Advanced",
        duration: "50 Days",
        overview:
          "An advanced program focused on offensive security, defensive security, real-world engagements, and capstone project development.",
        outcomes: [
        ...
        capstone:
          "Participants will complete a real-world cybersecurity project demonstrating assessment, remediation, reporting, and presentation skills.",
      },
    },
  },
  "ai-automation": {
    ...
    programs: {
      ...
      "mastery-program": {
        name: "AI Automation Mastery Program",
        level: "Advanced",
        duration: "50 Days",
        overview:
          "Master enterprise-grade AI automation, autonomous agents, multi-agent systems, and business transformation strategies.",
        outcomes: [],
        modules: [
          { title: "Core Modules", items: [
            "Advanced AI Agents",
        ...
        capstone: "Design and deploy a complete AI automation ecosystem solving real-world business challenges.",
      },
    },
  },
  "ai-fullstack": {
    ...
    programs: {
      ...
      "mastery-program": {
        name: "AI Full Stack Mastery Program",
        level: "Advanced",
        duration: "50 Days",
        overview:
          "An advanced development journey focused on building enterprise-grade AI applications, SaaS platforms, and intelligent systems.",
        outcomes: [],
        modules: [
          { title: "Core Modules", items: [
        ...
        capstone:
          "Build and deploy a complete AI-powered full-stack application from concept to production, showcasing architecture, development, deployment, and scalability expertise.",
      },
    },
  },
};
